              ...
              >
                ...
                <div className="space-y-0.5">
                  ...
                  <div className="flex justify-between text-[11px] md:text-xs">
                    ...
                    >
                      {category.variance >= 0 ? "+" : ""}$
                      {(category.variance / 1000).toFixed(1)}k
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg border border-[#E5E7EB] p-4 md:p-6">
          ...
          <div className="space-y-3 md:space-y-4">
            {departmentPerformance.map((dept) => (
              <div
                key={dept.name}
                className="pb-3 md:pb-4 border-b border-[#E5E7EB] last:border-b-0"
              >
                <div className="flex items-start justify-between mb-2 md:mb-3">
                  <div>
                    ...
                    <p className="text-xs text-[#7A7A7A]">
                      Budget: ${(dept.budgeted / 1000).toFixed(0)}k | Actual: $
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <span className="text-xs text-[#7A7A7A] whitespace-nowrap">
                    {dept.variance >= 0 ? "+" : ""}$
                    {(dept.variance / 1000).toFixed(1)}k
                  </span>
                </div>
              </div>
            ))}
