      ...
      <div className="p-3 md:p-4 bg-[#F6F8FA] min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3">
              {customerSegments.map((segment) => (
                ...
                >
                  ...
                  <p className="text-[11px] md:text-xs text-[#7A7A7A] mb-1">{segment.name}</p>
                  <h3 className="text-base md:text-lg font-bold text-[#2E5AAC] mb-2">
                    {segment.count}
                  </h3>
          ...
          <div className="bg-white rounded-lg border border-[#E5E7EB] p-3 md:p-4 mb-3">
            <div className="flex justify-between items-center mb-2 md:mb-3">
              <h2 className="text-sm md:text-base font-semibold text-[#2E5AAC]">Top Customers</h2>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[#E5E7EB]">
                    <th className="text-left text-[10px] md:text-xs font-semibold text-[#2E5AAC] px-2 md:px-3 py-1 md:py-2">
                      Cohort
                    </th>
                    <th className="text-left text-[10px] md:text-xs font-semibold text-[#2E5AAC] px-2 md:px-3 py-1 md:py-2">
                      Jan
                ...
                <tbody>
                  {cohortAnalysisData.map((row, index) => (
                    ...
                    >
                      <td className="text-[10px] md:text-xs font-medium text-[#2E5AAC] px-2 md:px-3 py-1 md:py-2">
                        {row.cohort}
                      </td>
