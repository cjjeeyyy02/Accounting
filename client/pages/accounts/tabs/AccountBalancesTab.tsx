...
export function AccountBalancesTab() {
  ...
  const totalBalance = mockAccountBalances.reduce(
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <Dialog
                    open={
                      isViewingDetails && selectedAccount?.id === account.id
                    }
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center justify-between">
                              ...
                              >
                                ...
                                <span>{selectedAccount?.trendValue}%</span>
                              </div>
                            </div>
                            <Progress
                              value={
                                selectedAccount?.trend === "up"
                                  ...
                                  : Math.abs(selectedAccount?.trendValue || 0) *
                                    10
                              }
                              className="h-2"
                            />
